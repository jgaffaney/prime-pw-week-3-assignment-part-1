...
let favoriteFoods = ['spaghetti', 'mashed potatoes', 'prime rib', 'lasagna', 'sushi'];
...
console.log('Number of favorite food: ', favoriteFoods.length);
...
favoriteFoods.unshift('peanut butter sandwich')
